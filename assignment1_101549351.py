...
# Checked if the name exists in the dictionary (case-sensitive)
if friend_name in ["Alex", "Jamie", "Taylor"]:  # Check if it's one of our friends
    ...
    # Printed the friend's workout details
...
git add assignment1_101549351.py
git commit -m "add complete Python code with all steps"
git push
